...
#ifndef TOKYOCOIN_INTERFACES_NODE_H
#define TOKYOCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a tokyocoin node (tokyocoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // TOKYOCOIN_INTERFACES_NODE_H
