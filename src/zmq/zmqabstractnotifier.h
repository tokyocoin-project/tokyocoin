// Copyright (c) 2015-2018 The Tokyocoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef TOKYOCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
#define TOKYOCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // TOKYOCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
