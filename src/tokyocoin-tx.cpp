...
static void SetupTokyocoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tokyocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tokyocoin-tx [options] <hex-tx> [commands]  Update hex-encoded tokyocoin transaction\n" +
            "or:     tokyocoin-tx [options] -create [commands]   Create hex-encoded tokyocoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tokyocoin transaction
