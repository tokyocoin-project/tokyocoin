...
#ifndef TOKYOCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define TOKYOCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@tokyocoin.
 *
 ...
 *
 * The chacha20-poly1305@tokyocoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@tokyocoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@tokyocoin are relatively fast in
...
#endif // TOKYOCOIN_CRYPTO_CHACHA_POLY_AEAD_H
