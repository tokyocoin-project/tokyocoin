...
#ifndef TOKYOCOIN_COMPAT_ASSUMPTIONS_H
#define TOKYOCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Tokyocoin cannot be compiled without assertions."
#endif
...
#endif // TOKYOCOIN_COMPAT_ASSUMPTIONS_H
