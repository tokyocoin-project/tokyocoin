...
#ifndef TOKYOCOIN_WALLET_WALLETUTIL_H
#define TOKYOCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! tokyocoin from opening the wallet, thinking it was newly created, and
...
#endif // TOKYOCOIN_WALLET_WALLETUTIL_H
