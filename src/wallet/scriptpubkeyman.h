...
#ifndef TOKYOCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define TOKYOCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Tokyocoin Core wallet was originally a collection of unrelated private
...
#endif // TOKYOCOIN_WALLET_SCRIPTPUBKEYMAN_H
