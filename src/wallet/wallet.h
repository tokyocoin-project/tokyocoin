...
#ifndef TOKYOCOIN_WALLET_WALLET_H
#define TOKYOCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this tokyocoin node, and set to 0 for transactions that were created
...
#endif // TOKYOCOIN_WALLET_WALLET_H
