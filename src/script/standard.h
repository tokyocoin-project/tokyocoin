...
#ifndef TOKYOCOIN_SCRIPT_STANDARD_H
#define TOKYOCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a tokyocoin address
 */
...
/**
 * Generate a Tokyocoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // TOKYOCOIN_SCRIPT_STANDARD_H
