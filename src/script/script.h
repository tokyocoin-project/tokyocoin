...
#ifndef TOKYOCOIN_SCRIPT_SCRIPT_H
#define TOKYOCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Tokyocoin always counted CHECKMULTISIGs
...
#endif // TOKYOCOIN_SCRIPT_SCRIPT_H
