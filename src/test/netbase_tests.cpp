...
{
    BOOST_CHECK(TestSplitHost("www.tokyocoin.de", "www.tokyocoin.de", -1));
    BOOST_CHECK(TestSplitHost("[www.tokyocoin.de]", "www.tokyocoin.de", -1));
    BOOST_CHECK(TestSplitHost("www.tokyocoin.de:80", "www.tokyocoin.de", 80));
    BOOST_CHECK(TestSplitHost("[www.tokyocoin.de]:80", "www.tokyocoin.de", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:1446", "127.0.0.1", 1446));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:1446", "127.0.0.1", 1446));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:1446", "::ffff:127.0.0.1", 1446));
    BOOST_CHECK(TestSplitHost("[::]:1446", "::", 1446));
    BOOST_CHECK(TestSplitHost("::1446", "::1446", -1));
    BOOST_CHECK(TestSplitHost(":1446", "", 1446));
    BOOST_CHECK(TestSplitHost("[]:1446", "", 1446));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:1446", "127.0.0.1:1446"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:1446", "[::]:1446"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
