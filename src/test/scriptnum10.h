...
#ifndef TOKYOCOIN_TEST_SCRIPTNUM10_H
#define TOKYOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Tokyocoin Core 0.10.0, for cross-comparison.
 */
public:
