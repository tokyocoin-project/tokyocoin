...
#ifndef TOKYOCOIN_POLICY_FEERATE_H
#define TOKYOCOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "TKC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    TKC_KVB,      //!< Use TKC/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from TKC/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::TKC_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif //  TOKYOCOIN_POLICY_FEERATE_H
