...
#ifndef TOKYOCOIN_QT_GUIUTIL_H
#define TOKYOCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Tokyocoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "tokyocoin:" URI into recipient object, return true on successful parsing
