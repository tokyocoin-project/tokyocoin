...
//! Entry point for TokyocoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &TokyocoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TokyocoinGUI tests.
void AppTests::guiTests(TokyocoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TokyocoinGUI::consoleShown, this, &AppTests::consoleTests);
