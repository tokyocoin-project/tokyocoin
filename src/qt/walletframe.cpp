...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, TokyocoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &TokyocoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &TokyocoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &TokyocoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &TokyocoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &TokyocoinGUI::updateWalletStatus);
    connect(gui, &TokyocoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
