    ...
    mapper(nullptr)
{
    ...
    ui->tokyocoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->tokyocoinAtStartup);
    ...
    ui->tokyocoinAtStartup->setToolTip(ui->tokyocoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->tokyocoinAtStartup->setText(ui->tokyocoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openTokyocoinConfButton->setToolTip(ui->openTokyocoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new TokyocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tokyocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTokyocoinConfButton_clicked()
{
