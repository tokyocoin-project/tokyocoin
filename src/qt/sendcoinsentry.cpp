    ...
    platformStyle(_platformStyle)
{
    ...
    // normal tokyocoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying tokyocoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &TokyocoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
