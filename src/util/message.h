...
#ifndef TOKYOCOIN_UTIL_MESSAGE_H
#define TOKYOCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's tokyocoin address, it must refer to a public key.
...
#endif // TOKYOCOIN_UTIL_MESSAGE_H
