 ...
 */
#ifndef TOKYOCOIN_UTIL_SYSTEM_H
#define TOKYOCOIN_UTIL_SYSTEM_H
...
extern const char * const TOKYOCOIN_CONF_FILENAME;
extern const char * const TOKYOCOIN_SETTINGS_FILENAME;
