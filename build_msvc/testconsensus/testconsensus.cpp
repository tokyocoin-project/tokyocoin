...
// tokyocoin includes.
#include <..\src\script\tokyocoinconsensus.h>
...
int main()
{
    std::cout << "tokyocoinconsensus version: " << tokyocoinconsensus_version() << std::endl;
    ...
    auto op0Result = tokyocoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, tokyocoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
