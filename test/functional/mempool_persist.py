...
By default, tokyocoind will dump mempool on shutdown and
...
class MempoolPersistTest(TokyocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent tokyocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
