...
"""Verify that starting tokyocoin with -h works as expected."""

from test_framework.test_framework import TokyocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(TokyocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tokyocoin with -h for help text")
        ...
        self.log.info("Start tokyocoin with -version for version information")
        ...
        self.log.info("Start tokyocoind with -fakearg to make sure it does not start")
