...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TokyocoinTestFramework
    pass


class ExampleTest(TokyocoinTestFramework):
    # Each functional test is a subclass of the TokyocoinTestFramework class.
    ...
    def custom_method(self):
        ...
        TokyocoinTestFramework class so other tests can use it."""
