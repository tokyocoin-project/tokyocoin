...
class P2PPermissionsTests(TokyocoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].tokyocoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].tokyocoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
