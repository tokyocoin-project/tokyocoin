...
class TestShell:
    """Wrapper Class for TokyocoinTestFramework.

    The TestShell class extends the TokyocoinTestFramework
    ...
    class __TestShell(TokyocoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by TokyocoinTestFramework child class.
            self.num_nodes = 1
