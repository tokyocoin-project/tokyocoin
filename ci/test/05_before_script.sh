...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Tokyocoin
else
  DOCKER_EXEC echo \> \$HOME/.tokyocoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/tokyocoin/tokyocoin/pull/18288#discussion_r433189350 for
  # details.
