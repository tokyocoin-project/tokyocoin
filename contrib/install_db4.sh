...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the tokyocoin repository."
  exit 1
fi
...
# See https://github.com/tokyocoin/tokyocoin/issues/16064
...
echo 'When compiling tokyocoind, run `./configure` in the following way:'
echo
