# Bootstrappable Tokyocoin Core Builds

This directory contains the files necessary to perform bootstrappable Tokyocoin
Core builds.
...
- 24GB of free disk space on the partition that the Tokyocoin Core git repository
  resides in
...
For a Tokyocoin Core depends development environment, simply invoke
...
From the top of a clean Tokyocoin Core repository:
...
To use dongcarl's substitute server for Tokyocoin Core builds after having
