...
This document provides guidelines for internationalization of the Tokyocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tokyocoin_en.ts` remains unchanged.
